...
namespace bgf
{
	...
	public:
		...
		static void drawSymbols(const Vector2 &position, const char &symbol, const bool &ignore_scene = false);
		static void drawSymbols(const Vector2 &position, const std::string &symbols, const bool &ignore_scene = false);
		static void drawRect(const Vector2 &position, const Vector2 &size, const bool &filled, const bool &ignore_scene = false);
